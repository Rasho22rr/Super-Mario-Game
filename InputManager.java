    ...
    MouseMotionListener, MouseWheelListener
{
   ...
   public void keyPressed(KeyEvent e) {
        ...
        if (gameAction != null) {
            // Create and execute KeyCommand
            Command command = new KeyCommand(gameAction);
            command.execute();
        }
    ...
    public void mousePressed(MouseEvent e) {
        ...
        if (gameAction != null) {
            // Create and execute MouseClickCommand
            Command command = new MouseClickCommand(gameAction);
            command.execute();
        }
    }
    ...
    public void mouseMoved(MouseEvent e) {
            ...
            centerLocation.y == e.getY())
        {
            ...
            // Create and execute MouseMoveCommand
            Command command = new MouseMoveCommand(mouseActions[MOUSE_MOVE_LEFT], dx, dy);
            command.execute();
...
private void mouseHelper(int codeNeg, int codePos, int amount) {
  ...
  if (amount < 0) {
    gameAction = mouseActions[codeNeg]; // Negative code for negative action
  } else {
    gameAction = mouseActions[codePos]; // Positive code for positive action
  }

  if (gameAction != null && amount > 0) {
